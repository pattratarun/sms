...
import com.pat.sms.global.config.LoginController;
import com.pat.sms.session.context.ThreadContext;
		...
		synchronized (session) {
			try {
				...
				try {
					...
					LOGGER.error("exception in LoginFilter while Cleaning up registry", ex);
				}
			}
		}
    }
